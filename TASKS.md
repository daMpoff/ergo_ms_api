...
# взаимосвязи модулей через конфиг
# активация модуля через конфиг

# связь по умолчанию
# связь настраиваемая

# попробовать отталкиваться от данных на различных этапах (получение из бд, после метода api)
# написать от данных методы
# комбинация методов

# может и не нужно подключать url других модулей
