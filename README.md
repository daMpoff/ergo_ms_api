...
- сделать так чтобы создавалось нормальное название класса app config нового модуля
- сделать так чтобы urls сами подтягивались
- решить что делать со скриптами poetry которые требуют введения параметров
