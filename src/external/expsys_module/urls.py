...
from src.external.expsys_module.views import  TeacherSubjectsView,SubjectCreateView,SubjectCompetenciesView,CompetenciesView
...
urlpatterns = [
     ...
     path('competencies/', SubjectCompetenciesView.as_view(), name='competencies'),
