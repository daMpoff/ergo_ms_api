"""
Модуль конфигурации для автоматической генерации API эндпоинтов.

Этот модуль содержит настройки для автоматической генерации API эндпоинтов на основе YAML конфигурации.
...
AUTO_API_CONFIG_PATH = 'src/config/auto_api.yaml'
