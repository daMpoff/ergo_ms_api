    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_creation', models.DateField(default=datetime.datetime(2025, 4, 2, 10, 56, 31, 579889))),
                ('last_update', models.DateTimeField(default=datetime.datetime(2025, 4, 2, 10, 56, 31, 579889))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
