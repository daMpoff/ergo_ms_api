    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_creation', models.DateField(default=datetime.datetime(2025, 4, 2, 11, 0, 20, 654241))),
                ('last_update', models.DateTimeField(default=datetime.datetime(2025, 4, 2, 11, 0, 20, 654241))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
