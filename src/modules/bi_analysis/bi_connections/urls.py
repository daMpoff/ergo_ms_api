...
from src.modules.bi_analysis.bi_connections.views import ConnectionListCreateView, ConnectionDetailView, CheckConnectionView, ConnectionTablesView, ConnectionFilesStatusView
